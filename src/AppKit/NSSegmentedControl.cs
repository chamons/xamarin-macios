...
namespace AppKit {
	...
	public partial class NSSegmentedControl {
		...
		public static NSSegmentedControl FromLabels (string[] labels, NSSegmentSwitchTracking trackingMode, global::System.Action action)
		{
		...
		[Introduced (PlatformName.MacOSX, 10, 12)]
		public static NSSegmentedControl FromImages (NSImage[] images, NSSegmentSwitchTracking trackingMode, global::System.Action action)
		{
			var dispatcher = new NSActionDispatcher (action);
