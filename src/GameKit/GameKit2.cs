...
namespace XamCore.GameKit {
	...
	public partial class GKScore {
		[Introduced (PlatformName.iOS, 4, 1, message: "Use LeaderboardIdentifier instead"), Introduced (PlatformName.MacOSX, 10, 8, message: "Use LeaderboardIdentifier instead"), Deprecated (PlatformName.iOS, 8, 0, message: "Use LeaderboardIdentifier instead"), Deprecated (PlatformName.MacOSX, 10, 10, message: "Use LeaderboardIdentifier instead")]
