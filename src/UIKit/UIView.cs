...
namespace UIKit {
	public partial class UIView : IEnumerable {
		...
		class _UIViewStaticCallback : NSObject {
			...
			public event global::System.Action WillStart, WillEnd;
		...
		public static event global::System.Action AnimationWillStart {
			add {
		...
		public static event global::System.Action AnimationWillEnd {
			add {
		...
		public static void Animate (double duration, global::System.Action animation, global::System.Action completion)
		{
		...
		[Advice ("Use the *Notify method that has 'UICompletionHandler completion' parameter, the 'bool' will tell you if the operation finished.")]
		public static void Animate (double duration, double delay, UIViewAnimationOptions options, global::System.Action animation, global::System.Action completion)
		{
			// animation null check will be done in AnimateNotify
		...
		[Advice ("Use the *Notify method that has 'UICompletionHandler completion' parameter, the 'bool' will tell you if the operation finished.")]
		public static void Transition (UIView fromView, UIView toView, double duration, UIViewAnimationOptions options, global::System.Action completion)
		{
		...
		[Advice ("Use the *Notify method that has 'UICompletionHandler completion' parameter, the 'bool' will tell you if the operation finished.")]
		public static void Transition (UIView withView, double duration, UIViewAnimationOptions options, global::System.Action animation, global::System.Action completion)
		{
			// animation null check will be done in AnimateNotify
		...
		public static Task<bool> AnimateAsync (double duration, global::System.Action animation)
		{
