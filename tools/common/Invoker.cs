...
namespace Xamarin.Bundler
{
	...
	{
		public static int RunCommand (string path, string args, int verbose = 0, string [] env = null, StringBuilder output = null, bool suppressPrintOnErrors = false)
		{
		...
		public static Task<int> RunCommandAsync (string path, string args, int verbose = 0, string [] env = null, StringBuilder output = null, bool suppressPrintOnErrors = false)
		{
			return Task.Run (() => RunCommand (path, args, verbose, env, output, suppressPrintOnErrors));
		}
	}
}
